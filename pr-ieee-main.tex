...
\begin{frame}
  ...
  \begin{itemize}
  \item Standard für wissenschaftliche Publikationen in der Informatik
...
\begin{frame}
  \frametitle{Fazit}
  \begin{itemize}
  \item \hologo{(La)TeX} als Tool für alles
  \item \hologo{(La)TeX} macht Spaß (außer bei Fehlern)
  \item schier unendliche Möglichkeiten
  \item \emph{aber} zum Teil hoher Lernaufwand
  \end{itemize}
\end{frame}
