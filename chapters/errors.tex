...
\begin{frame}[fragile]
  ...
  \only<1->{%
    \begin{columns}[T]
      \begin{column}{.5\textwidth}
        \examplefile{examples/brackets.tex}{https://github.com/sl-gap/tex-tutorial/blob/master/examples/errors/brackets.tex}
...
\begin{frame}
  ...
  \only<1>{%
  \examplefile{examples/align.tex}{https://github.com/sl-gap/tex-tutorial/blob/master/examples/errors/align.tex}
