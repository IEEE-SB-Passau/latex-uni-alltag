  ...
  \only<1->{%
    \begin{columns}[T]
      \begin{column}{.5\textwidth}
        \examplefile{examples/errors/typo.tex}{https://github.com/sl-gap/tex-tutorial/blob/master/examples/errors/typo.tex}
...
% \begin{frame}
%   \frametitle{Undefinierte Zeichen}
%   \only<1->{%
%     \begin{columns}[T]
%       \begin{column}{.5\textwidth}
%         \examplefile{examples/errors/undef-char.tex}{https://github.com/sl-gap/tex-tutorial/blob/master/examples/errors/undef-char.tex}
%         \lstinputlisting[language={[LaTeX]TeX},inputencoding=utf8,extendedchars=true]{examples/errors/undef-char.tex}
%       \end{column}
%       \begin{column}{.5\textwidth}
%         Fehlermeldung:
%         \lstinputlisting{examples/errors/undef-char.err}
%       \end{column}
%     \end{columns}
%   }% End of \only<1->
%   \only<2->{%
  ...
  \frametitle{Überschreiben eines vorhandenen Kommandos}
    \begin{columns}[T]
      \only<1->{\begin{column}{.5\textwidth}
        \examplefile{examples/errors/renewcommand.tex}{https://github.com/sl-gap/tex-tutorial/blob/master/examples/errors/renewcommand.tex}
